-- HR Core Enterprise additive migration 0003
...
('organization.view','عرض الهيكل التنظيمي','عرض الهيكل التنظيمي'),
('organization.manage','إدارة الهيكل التنظيمي','إدارة الهيكل التنظيمي'),
('organization.assign','تسكين الموظفين','تسكين الموظفين'),
('transactions.builder','منشئ المعاملات','منشئ المعاملات'),
('system.maintenance','صيانة قاعدة البيانات','صيانة قاعدة البيانات');

INSERT OR IGNORE INTO system_schema_versions(version) VALUES(1);
